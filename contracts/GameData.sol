...
contract GameData {
    ...
    constructor() {
        ...
        pathTypeToData[PathType.BROKEN_TRACK] = PathData(
            ...
            200, 400, 5, 1, 25,
            [PathType.MINE_TUNNEL, PathType.FRAGILE_CAVE, PathType.BROKEN_TRACK]
        );
        ...
        pathTypeToData[PathType.NARROW_CAVE] = PathData(
            ...
            100, 200, 15, 10, 30,
            [PathType.FRAGILE_CAVE, PathType.LOOSE_PLANKS, PathType.MINE_TUNNEL]
        );
        pathTypeToData[PathType.SMELL_OF_FIRE] = PathData(
            ...
            800, 1000, 70, 0, 30,
            [PathType.OLD_LADDER, PathType.FRAGILE_CAVE, PathType.MINE_TUNNEL]
        );
        pathTypeToData[PathType.OLD_LADDER] = PathData(
            PathType.OLD_LADDER,
            "Old ladder",
            "The old ladder groans and squeaks as you climb up to continue on.",
            "Time has degraded this old ladder more than first perceived. \'Maybe it\'ll last until I reach the top?\' you hope, but then scream as it collapses in front of you.",
            400, 500, 15, 10, 30,
        ...
        pathTypeToData[PathType.DESERT] = PathData(
            ...
            "Desert",
            "",
            "You walk the desert for hours and finally see lake and palace in the distance. As you get closer, you realize the heat dancing off the sand has been playing tricks on you, but it is too late. You collapse from thirst.",
            400, 500, 15, 10, 30,
            [PathType.SMELL_OF_FIRE, PathType.FRIENDLY_RAT, PathType.PALACE]
        );
        pathTypeToData[PathType.PALACE] = PathData(
            ...
            5000, 50000, 0, 100, 0,
            [PathType.FRIENDLY_RAT, PathType.DESERT, PathType.PALACE]
        );
